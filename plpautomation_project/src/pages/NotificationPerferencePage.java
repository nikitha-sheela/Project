...
public class NotificationPerferencePage {
	@FindBy(xpath = "//div[@class='ooJZfD _2oZ8XT']")
	private WebElement mailOptions;
	@FindBy(xpath = "//div[@class='ooJZfD _2oZ8XT']")
	private WebElement smsOptions;
	@FindBy(xpath = "//div[@class='ooJZfD _2oZ8XT']")
	private WebElement appOptions;
	...
	public NotificationPerferencePage() {
		PageFactory.initElements(BaseClass.c, this);
	}

	public void validateWithMailOptions() {
		assertTrue(mailOptions.isDisplayed(), "mail options are not displayed");
		System.out.println("mail options are displayed");
		Reporter.log(" mail options are displayed");
	}
	...
	public void validateWithAppOptions() {
		assertTrue(appOptions.isDisplayed(), "app options are not displayed");
		System.out.println("app options are displayed");
		Reporter.log("app options are displayed");
	}

	public void validateWithSmsOptions() {
		assertTrue(smsOptions.isDisplayed(), "sms options are not displayed");
		System.out.println("sms options are displayed");
		Reporter.log("sms options are displayed");
	}
